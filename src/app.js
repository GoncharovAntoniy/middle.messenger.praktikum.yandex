...
// import namespace from "./utils/practiceTS";
...
//           const mediaUrl = URL.createObjectURL(e.target.files[0]);
//           this.updateStateModalProfile(
//             {
//               ...this.state.modalProfileInfo,
//               infoInput: {
//                 ...this.state.modalProfileInfo.infoInput,
//                 value: mediaUrl,
//               },
//             },
//             true,
...
//           this.state.contextProfile.avatarInfo.avatar =
...
//       if (this.updatePass) {
//         const { saveDataBtn, oldPassInput, newPassInput, RePassInput } =
//           documentElements();
...
//     this.state = {
//       ...this.state,
//       modalInfo: { ...this.state.modalInfo, ...newModalInfo },
//     };
...
//     this.state = {
//       ...this.state,
//       modalProfileInfo: { ...this.state.modalProfileInfo, ...newModalInfo },
//     };
//     const { profile, modalProfile } = documentElements();
//     const template = Handlebars.compile(
//       ProfileComponents.ModalUpdateIconProfile,
//     );
...
//     this.state.fields = this.state.fields.map(item =>
//       id === item.id ? { ...item, value: newValue } : { ...item },
//     );
//     this.render();
//   }

//   changeDataPass(id, newValue) {
//     this.state.fieldsPass = this.state.fieldsPass.map(item =>
//       id === item.id ? { ...item, value: newValue } : { ...item },
//     );
//     this.render();
//   }
